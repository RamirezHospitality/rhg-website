 ...
 * Route: /lp/hotel-asset-management
 * Keyword theme: "hotel asset management" (H1 message-match)
 * Ad group: RHG | Search | Revenue Management | US (new ad group, per
 * landing-page-specs.md — targets "hotel asset management/asset manager/asset
 * advisory"; most speculative of the three per the spec, built last)
 *
...
const SOURCE = "lp/hotel-asset-management";
...
export default function HotelAssetManagementLP() {
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-background text-foreground pb-20 lg:pb-0">
      <SEO
        title="Hotel Asset Management for Independent Owners | Ramirez Hospitality Group"
        description="Hotel asset management for independent hotel owners and investors. Every client starts with The Modern Hotel Audit: free, scored, sized in dollars. Operator-side oversight and accountability, measured beyond RevPAR."
        canonical="/lp/hotel-asset-management"
        noindex
      />
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-14 items-start">
              <div className="lg:col-span-7">
                ...
                <h1 className="mt-6 font-display font-medium text-[2.4rem] sm:text-5xl lg:text-[3.9rem] leading-[1.06] text-cream tracking-[-0.025em]">
                  ...
                  <br />
                  <span className="italic text-brass">for Independent Owners</span>
                </h1>
                <p className="mt-7 text-cream/85 text-lg md:text-xl leading-[1.55] max-w-2xl">
                  Operator-side oversight for owners and investors who want to know what a
                  management company is actually delivering, measured beyond RevPAR. Run by
                  someone who has operated the properties, not just reported on them.
                </p>
                ...
                <div className="mt-9 grid sm:grid-cols-2 gap-px bg-brass/15 border border-brass/15 max-w-2xl">
                  <div className="bg-card p-6">
                    ...
                    <div className="mt-3 text-cream/75 text-sm leading-[1.6]">
                      Hospitality properties worked with
                    </div>
                  </div>
                  <div className="bg-card p-6">
                    <div className="font-display text-4xl text-brass leading-none">4</div>
                    <div className="mt-3 text-cream/75 text-sm leading-[1.6]">
                      Properties repositioned end to end
                    </div>
                  </div>
                </div>
                <p className="mt-5 text-[0.7rem] tracking-[0.2em] uppercase text-cream/55">
                  10+ years · Operator-side experience · Beyond RevPAR: revenue per available
                  square foot
                </p>
