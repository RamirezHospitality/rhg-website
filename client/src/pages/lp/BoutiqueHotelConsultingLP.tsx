 ...
 * Route: /lp/boutique-hotel-consulting
 * Keyword theme: "boutique hotel consulting" (H1 message-match)
 * Ad group: RHG | Search | Revenue Management | US (new ad group, per
 * landing-page-specs.md — targets "boutique/independent hotel consultant")
 *
...
const SOURCE = "lp/boutique-hotel-consulting";
...
export default function BoutiqueHotelConsultingLP() {
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-background text-foreground pb-20 lg:pb-0">
      <SEO
        title="Boutique Hotel Consulting from an Operator, Not an Agency | Ramirez Hospitality Group"
        description="Boutique hotel consulting for independent hotels and small groups. Every client starts with The Modern Hotel Audit: free, scored, sized in dollars. Revenue management, operations, and tech stack from a working operator, not an agency."
        canonical="/lp/boutique-hotel-consulting"
        noindex
      />
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-14 items-start">
              <div className="lg:col-span-7">
                ...
                <h1 className="mt-6 font-display font-medium text-[2.4rem] sm:text-5xl lg:text-[3.9rem] leading-[1.06] text-cream tracking-[-0.025em]">
                  ...
                  <br />
                  <span className="italic text-brass">from an Operator, Not an Agency</span>
                </h1>
